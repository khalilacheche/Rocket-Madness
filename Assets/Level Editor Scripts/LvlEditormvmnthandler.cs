...
public class LvlEditormvmnthandler : MonoBehaviour
{
    bool isPressing;
    Vector3 startPos;
    Vector3 mousePos;
    ...
    void Start()
    {
        ...
        gm = GameObject.FindGameObjectWithTag("GameManager").GetComponent<LvlEditorManager>();
    ...
    void Update()
    {
        if (isPressing)
        {
            ...
            GameObject.Find("Trajectory Pedictor").GetComponent<LvlEditortrajectory>().CalcTraj();
        }
        else
        {
